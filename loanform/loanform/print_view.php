...
<div class="container">
    ...
    <h3>तारण मालमत्ता</h3>
    <div class="field"><span class="label">🏠 मालमत्ता प्रकार:</span> <span class="dotted-line"><?php echo htmlspecialchars($data['collateral']); ?></span></div>
    <div class="field"><span class="label">📝 मालमत्ता कोणाच्या नावावर:</span> <span class="dotted-line"><?php echo htmlspecialchars($data['collateral_owner']); ?></span></div>

    <h3>उत्पन्न आणि खर्च</h3>
    <div class="field"><span class="label">💰 व्यवसायाचे वार्षिक उत्पन्न:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['annual_income']); ?></span></div>
    ...
    <div class="field"><span class="label">💼 नोकरीधारक उत्पन्न:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['job_income']); ?></span></div>
    ...
    <div class="field"><span class="label">🏠 घर/गोदाम भाडे उत्पन्न:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['rental_income']); ?></span></div>
    <div class="field"><span class="label">🚛 व्यावसायिक वाहन उत्पन्न:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['vehicle_income']); ?></span></div>
    <div class="field"><span class="label">🌾 शेती उत्पन्न:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['farming_income']); ?></span></div>

    <h3>कर्जाची माहिती</h3>
    <div class="field"><span class="label">❓ कर्जाचा हेतू:</span> <span class="dotted-line"><?php echo htmlspecialchars($data['loan_reason']); ?></span></div>
...
<div class="field"><span class="label">📈 गुंतवणूक:</span> <span class="dotted-line">₹<?php echo htmlspecialchars($data['investment']); ?></span></div>
    ...
    <div class="field">
        ...
        <img src="<?php echo htmlspecialchars($data['mortgage_photo']); ?>" alt="तारण मालमत्तेचा फोटो">
    </div>
    <div class="field">
        <span class="label">👤 व्यवसाय मालकाचा फोटो:</span><br>
        <img src="<?php echo htmlspecialchars($data['owner_photo']); ?>" alt="व्यवसाय मालकाचा फोटो">
    </div>
