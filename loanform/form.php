...
<head>
    ...
    <style>
        body {
            background-color: #ffefd5; /* Light pastel background */
        }
        .navbar {
            background-color: #ffefd5; /* Slightly darker pastel for contrast */
        }
        .navbar-brand {
            font-weight: bold;
            font-size: 24px;
...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid d-flex justify-content-center">
        <a class="navbar-brand text-center mx-auto" href="#">Shri Chhatrapati Rajarshi Shahu Urban Coop Bank Ltd Beed</a>
